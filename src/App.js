...
function App() {
  ...
  return (
   ...
   <Button onClick={toggleHandler} >Insert User</Button>
    <input type="text" name="user" value={searchUser} placeholder="Enter your username" onChange={(e) => setSearchUser(e.target.value) }/>
   </Container>
    {toggle && (
    ...
    <Container>
      ...
      <List users={searchHandler()} editHandler={editHandlerUser}  deleteHandler={deleteHandler}/>
    </Container>
    </>
  );
}
